...
echo ""
echo "Workflow:"
echo "  Standard: /branch:feature → /feature → /extract → /execute → /test:write → /build → /commit → /pr"
echo "  Fast:     /branch:feature → /feature → /extract → /execute → /test:write → /build:fast → /pr"
